...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      border-2 border-black transition-colors focus-visible:outline-none
      ...
      data-[state=checked]:bg-main data-[state=unchecked]:bg-white`,
      className,
    )}
    {...props}
    ref={ref}>
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        ring-0 transition-transform data-[state=checked]:translate-x-6
